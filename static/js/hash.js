String.prototype.MD5 = function (bit)
{
    ...
    function ConvertToWordArray(mSg)
    { 
        var lWordCount; 
        var lMessageLength = mSg.length; 
        ...
        { 
            ...
            lWordArray[lWordCount] = (lWordArray[lWordCount] | (mSg.charCodeAt(lByteCount)<<lBytePosition)); 
            lByteCount++; 
        } 
        lWordCount = (lByteCount-(lByteCount % 4))/4; 
        lBytePosition = (lByteCount % 4)*8; 
...
String.prototype.SHA256 = function() {
    ...
    Sigma0 = function(x) { return ROTR(2,  x) ^ ROTR(13, x) ^ ROTR(22, x); }
    Sigma1 = function(x) { return ROTR(6,  x) ^ ROTR(11, x) ^ ROTR(25, x); }
    sigma0 = function(x) { return ROTR(7,  x) ^ ROTR(18, x) ^ (x>>>3);  }
    sigma1 = function(x) { return ROTR(17, x) ^ ROTR(19, x) ^ (x>>>10); }
...
String.prototype.CRC32 = function() {
    ...
    var values = stringToArray(msg) ,l = values.length, crc = -1;
    for (var i = 0,id = 0; i < l; i++) {
        id = (values[i].id >>> 0) ;
